...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-07-2025 a las 20:37:35
...
INSERT INTO `documento` (`id`, `nombre_doc`) VALUES
(4, 'Certificado de Estudios Secundarios'),
(1, 'DNI Frontal'),
(2, 'DNI Posterior'),
(6, 'Documento Extra'),
...
INSERT INTO `documento_inscripcion` (`inscripcion_id`, `documento_id`, `file_name`, `storage_name`, `extension`, `uploaded_at`) VALUES
(22, 1, '76771702 - Orden de Pago.pdf', '51a2b6013445de91d2056cbf1c3613c3', 'pdf', '2025-07-08 07:53:46'),
(22, 2, 'documentoescaneado3.pdf', '52942b500d86421d15844be5d8af7fee', 'pdf', '2025-07-08 07:53:46'),
(22, 3, 'documentoescaneado5.pdf', '6eebcd268fd2bd804015cac1a23c6249', 'pdf', '2025-07-08 07:53:46'),
(22, 4, 'documentoescaneado2.pdf', '3bdad778fa23e48ef5db938ac0eee08a', 'pdf', '2025-07-08 07:53:47'),
(22, 5, 'documentoescaneado4.pdf', '04b2de4533b45fbfb0783bea3fccfd45', 'pdf', '2025-07-08 07:53:47'),
(22, 6, 'documentoescaneado1.pdf', '89a26c3dadb04ece3bddea8969141968', 'pdf', '2025-07-08 07:53:47'),
(23, 1, '76771702 - Orden de Pago.pdf', 'f3406ff3901a2257e76d15d5cf2ac656', 'pdf', '2025-07-08 07:54:49'),
(23, 2, 'documentoescaneado3.pdf', 'f5f1fd07bfed8291f71a847ab437f422', 'pdf', '2025-07-08 07:54:49'),
(23, 3, 'documentoescaneado5.pdf', 'b955853ad2d9c79b71427fb382bb2793', 'pdf', '2025-07-08 07:54:49'),
(23, 4, 'documentoescaneado2.pdf', 'e69f9990f7ee5846322fbc18927833d2', 'pdf', '2025-07-08 07:54:49'),
(23, 5, 'documentoescaneado4.pdf', 'd42cd083ee385d0014ab29126a7afb44', 'pdf', '2025-07-08 07:54:49'),
(23, 6, 'documentoescaneado1.pdf', '6e10b901a90977bd4bcd2ab1fd685b2d', 'pdf', '2025-07-08 07:54:49');
...
CREATE TABLE `inscripcion` (
  ...
  `proceso_admision` varchar(10) NOT NULL,
  `modalidad_id` int(11) NOT NULL,
  `tipo_exoneracion_id` int(11) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `discapacidad` varchar(20) DEFAULT NULL,
  `desc_discapacidad` text DEFAULT NULL,
  `medio_difusion` varchar(50) DEFAULT NULL,
...
INSERT INTO `inscripcion` (`id`, `postulante_id`, `proceso_admision`, `modalidad_id`, `tipo_exoneracion_id`, `created_at`, `updated_at`, `discapacidad`, `desc_discapacidad`, `medio_difusion`, `medio_otro`) VALUES
(22, 34, '2025-I', 1, NULL, '2025-07-08 07:53:46', '2025-07-08 07:53:46', 'Ninguna', '', 'Internet', ''),
(23, 35, '2025-I', 1, NULL, '2025-07-08 07:54:49', '2025-07-08 07:54:49', 'Ninguna', '', 'Internet', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `inscripcion_programa`
--
...
--
-- Volcado de datos para la tabla `inscripcion_programa`
--

INSERT INTO `inscripcion_programa` (`inscripcion_id`, `programa_id`, `orden`) VALUES
(1, 3, 2),
(1, 7, 1),
(2, 1, 1),
(2, 4, 2),
...
CREATE TABLE `postulante` (
  ...
  `ubigeo_id` int(11) NOT NULL,
  `ano_egreso` year(4) NOT NULL,
  `estado_inscripcion` int(11) DEFAULT 0,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `ubigeo_nacimiento_id` int(11) DEFAULT NULL,
...
INSERT INTO `postulante` (`id`, `dni`, `apellido_paterno`, `apellido_materno`, `nombres`, `fecha_nacimiento`, `genero_id`, `telefono`, `email`, `direccion`, `ubigeo_id`, `ano_egreso`, `estado_inscripcion`, `created_at`, `updated_at`, `ubigeo_nacimiento_id`, `foto`) VALUES
(34, '71961590', 'Perdomo', 'Macedo', 'Paul Ander', '2002-04-10', 1, '924360327', 'perdomopaul10@gmail.com', 'Tacna 537', 220901, '2018', 0, '2025-07-08 07:53:46', '2025-07-08 07:53:46', 220901, '71961590_1751961226.jpg'),
(35, '71961591', 'Perdomo', 'Macedo', 'Emy', '1999-07-04', 1, '924332232', 'emyperdomo04@gmail.com', 'Tacna 537', 220901, '2018', 0, '2025-07-08 07:54:48', '2025-07-08 07:54:48', 220901, '71961591_1751961288.jpg');
...
(2, 'Administración de Centros de Computo'),
...
(9, 'Mecánica de Producción Industrial'),
(8, 'Mecatrónica Automotriz'),
(10, 'Producción Agropecuaria');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tipo_exoneracion`
--
...
--
-- Volcado de datos para la tabla `tipo_exoneracion`
--

INSERT INTO `tipo_exoneracion` (`id`, `nombre`) VALUES
(6, 'CEPRE'),
...
(250402, 'departamento', 'provincia', 'distrito'),
...
(90718, 'HUANCAVELICA', 'TAYACAJA', 'ANDAYMARCA'),
...
(90708, 'HUANCAVELICA', 'TAYACAJA', 'HUARIBAMBA'),
(90709, 'HUANCAVELICA', 'TAYACAJA', 'ÑAHUIMPUQUIO'),
(90701, 'HUANCAVELICA', 'TAYACAJA', 'PAMPAS'),
(90710, 'HUANCAVELICA', 'TAYACAJA', 'PAZOS'),
(90720, 'HUANCAVELICA', 'TAYACAJA', 'PICHOS'),
(90717, 'HUANCAVELICA', 'TAYACAJA', 'QUICHUAS'),
(90711, 'HUANCAVELICA', 'TAYACAJA', 'QUISHUAR'),
(90719, 'HUANCAVELICA', 'TAYACAJA', 'ROBLE'),
(90712, 'HUANCAVELICA', 'TAYACAJA', 'SALCABAMBA'),
(90713, 'HUANCAVELICA', 'TAYACAJA', 'SALCAHUASI'),
(90714, 'HUANCAVELICA', 'TAYACAJA', 'SAN MARCOS DE ROCCHAC'),
(90721, 'HUANCAVELICA', 'TAYACAJA', 'SANTIAGO DE TUCUMA'),
(90715, 'HUANCAVELICA', 'TAYACAJA', 'SURCUBAMBA'),
(90716, 'HUANCAVELICA', 'TAYACAJA', 'TINTAY PUNCU'),
...
CREATE TABLE `usuarios` (
  ...
  `rol` enum('admin','secretaria','verificador','postulante') NOT NULL,
...
INSERT INTO `usuarios` (`id_usuario`, `username`, `password`, `nombre_completo`, `rol`, `estado`, `created_at`) VALUES
(5, 'admin', '$2y$10$Hu/kuywGmaJ7Lrzvoz/yXuMMne.8M8OSGfT/.iCvegVrHaO6zdoi.', 'Administrador Principal', 'admin', 1, '2025-06-27 16:29:22'),
(6, 'secretaria', '$2y$10$YpG4.1i4yTrPVmT0Oz9MHOnMnsFXyTXn7Ply0loWSZxGw5RbvKOm21', 'Secretaria Principal', 'secretaria', 1, '2025-06-27 16:29:22'),
(7, 'verificador', '$2y$10$YpG4.1i4yTrPVmT0Oz9MHOnMnsFXyTXn7Ply0loWSZxGw5RbvKOm21', 'Verificador de Documentos', 'verificador', 1, '2025-06-27 16:29:22'),
(8, 'postulante', '$2y$10$YpG4.1i4yTrPVmT0Oz9MHOnMnsFXyTXn7Ply0loWSZxGw5RbvKOm21', 'Juan Pérez', 'postulante', 1, '2025-06-27 16:29:22'),
(10, 'admin2', '$2y$10$Hu/kuywGmaJ7Lrzvoz/yXuMMne.8M8OSGfT/.iCvegVrHaO6zdoi.', 'Nuevo Administrador', 'admin', 1, '2025-06-27 17:21:59'),
(11, 'admin3', '$2y$10$Q8Cika0yK9ZJ0IerSYi0wOUUJdS32sP4GoXjF8KroCTo2GWegfp9C', '', 'admin', 1, '2025-07-02 06:26:06'),
(12, 'secretaria1', '$2y$10$rD6zhAukplxC95sz2pRkeOx4e1KmuIHjcnibA7LRsUyF3wywFmZAS', '', 'secretaria', 1, '2025-07-02 06:27:47');
...
ALTER TABLE `documento`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `nombre_doc` (`nombre_doc`);

--
-- Indices de la tabla `documento_inscripcion`
--
ALTER TABLE `documento_inscripcion`
  ADD PRIMARY KEY (`inscripcion_id`,`documento_id`),
...
ALTER TABLE `inscripcion`
  ...
  ADD KEY `tipo_exoneracion_id` (`tipo_exoneracion_id`);

--
-- Indices de la tabla `inscripcion_programa`
--
ALTER TABLE `inscripcion_programa`
  ADD PRIMARY KEY (`inscripcion_id`,`programa_id`),
...
--
-- Indices de la tabla `tipo_exoneracion`
--
ALTER TABLE `tipo_exoneracion`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `nombre` (`nombre`);
...
--
-- AUTO_INCREMENT de la tabla `tipo_exoneracion`
--
ALTER TABLE `tipo_exoneracion`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `ubigeo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=250404;
...
--
ALTER TABLE `apoderado`
  ADD CONSTRAINT `apoderado_ibfk_1` FOREIGN KEY (`inscripcion_id`) REFERENCES `inscripcion` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `apoderado_ibfk_2` FOREIGN KEY (`ubigeo_id`) REFERENCES `ubigeo` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_apoderado_inscripcion_id` FOREIGN KEY (`inscripcion_id`) REFERENCES `inscripcion` (`id`);

--
-- Filtros para la tabla `documento_inscripcion`
--
ALTER TABLE `documento_inscripcion`
  ADD CONSTRAINT `documento_inscripcion_ibfk_1` FOREIGN KEY (`inscripcion_id`) REFERENCES `inscripcion` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `documento_inscripcion_ibfk_2` FOREIGN KEY (`documento_id`) REFERENCES `documento` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `inscripcion`
--
ALTER TABLE `inscripcion`
  ADD CONSTRAINT `inscripcion_ibfk_1` FOREIGN KEY (`postulante_id`) REFERENCES `postulante` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `inscripcion_ibfk_2` FOREIGN KEY (`modalidad_id`) REFERENCES `modalidad` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `inscripcion_ibfk_3` FOREIGN KEY (`tipo_exoneracion_id`) REFERENCES `tipo_exoneracion` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
